...
test("fallback_dict_length_issue", async () => {
  ...
  await client.hSet("room:default:config", "setting1", JSON.stringify("value1"));
  await client.hSet("room:default:config", "setting2", JSON.stringify("value2"));
  await client.hSet("room:default:config", "setting3", JSON.stringify("value3"));
